...
const int MIN_FECHA = 1988;
const int MAX_FECHA = 2008;
...
const int MIN_TALLA_ZAPATOS = 33;
const int MAX_TALLA_ZAPATOS = 47;
// Rangos de talla para multiplicarlos
const int MAX_RANGO_TALLA1 = 37;
const int MAX_RANGO_TALLA2 = 42;
...
// Puntos Obtenidos
const int MIN_PUNTOS = 5;
const int MED_PUNTOS = 15;
...
const int NUMERO_DIV = 20;

// Alturas Predeterminadas
const int ALTURA_JOHNNY_BRAVO = 180;
...
const int MIN_RANGO_PERSONAJE1 = 1;
const int MAX_RANGO_PERSONAJE1 = 80;
const int MAX_RANGO_PERSONAJE2 = 160;
const int MAX_RANGO_PERSONAJE3 = 240;
...
int main(){
    ...
    nombrePersonaje = calcula_personaje(puntosTotales, alturaPersonaje);

    imprimir_resultado(puntosTotales, nombrePersonaje);
